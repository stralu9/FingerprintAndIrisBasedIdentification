...
# %% Cleaning
	...
	print("[removing ...]")
	minutiaeTerm = removeSpuriousMinutiae(RP, 30, minutiaeTerm, mask);
	print(minutiaeBif[minutiaeBif!=0].size)    
	minutiaeBif = removeSpuriousMinutiae(skimage.measure.regionprops(minutiaeBif), 0, minutiaeBif, mask);
	print(minutiaeBif[minutiaeBif!=0].size)
